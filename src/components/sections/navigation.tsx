        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur-md border-b border-border pointer-events-auto">
          <div className="flex flex-col p-4 gap-2">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMobileMenuOpen(false)}
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground hover:opacity-90 font-mono font-medium py-3 px-4 rounded-full transition-all text-[15px] mt-2"
            >
              <GitHubIcon className="w-4 h-4" />
              <span>GitHub</span>
            </a>
