...
| `icon-120x120.png` | 120×120 | iOS legacy devices |
...
| `apple-touch-icon-180x180.png` | 180×180 | iOS home screen (Add to Home Screen) |
...
<Steps>
  ...
  <Step title="Generate PNGs">
    ...
    magick -background none -density 300 ../favicon.svg \
      -resize 180x180 apple-touch-icon-180x180.png
    ```
  </Step>
</Steps>
